...
public class KColorPickerDialog extends Dialog {
     ...
     * @param listener 回调
     */
    public KColorPickerDialog(Context context, String title,
     ...
     * @param listener 回调
     */
    public KColorPickerDialog(Context context, int initialColor,
                ...
                case MotionEvent.ACTION_UP:
                	if(highlightCenter && inCenter) {//点击在中心圆, 且当前启动在中心圆
                		if(mListener != null) {
                    		...
                    		KColorPickerDialog.this.dismiss();
                		}
                	}
                	if(downInCircle) {
                		downInCircle = false;
